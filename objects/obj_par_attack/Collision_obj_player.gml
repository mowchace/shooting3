...
with(other){
	if(attribute == "Iron"){
		create_range_attack(obj_reflect,_damegepoint/2+Dexterity_MeeleeATK,-other.direction+irandom_range(-45,45),other.speed,faction,id,noone,attack_positionX,attack_positionY,attack_particlepositionX,attack_particlepositionY);
	}else{
