...
with(other){
	if(attribute == "Iron"){
		if(other.Characteristic == "normal"){
			...
			create_range_attack(obj_reflect,other.damegePoint_Calculated_value/2,irandom_range(0,359),other.reflectspeed,faction,id,noone,attack_positionX,attack_positionY,attack_particlepositionX,attack_particlepositionY);
		}
	}
}
